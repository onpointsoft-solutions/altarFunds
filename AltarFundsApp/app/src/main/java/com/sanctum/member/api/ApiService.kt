...
interface ApiService {
    ...
    @POST("devotionals/{id}/react/")
    suspend fun reactToDevotional(@Path("id") devotionalId: Int, @Body request: Map<String, String>): Response<Reaction>
    
    @DELETE("devotionals/{id}/react/")
    suspend fun removeDevotionalReaction(@Path("id") devotionalId: Int, @Query("reaction_type") reactionType: String): Response<Void>
