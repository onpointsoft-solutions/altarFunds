package com.sanctum.member.ui.church
...
import com.sanctum.member.databinding.ActivityChurchDetailsBinding
...
class ChurchDetailsActivity : AppCompatActivity() {
    ...
    private fun displayChurchDetails(church: com.sanctum.member.models.Church) {
