...
import com.sanctum.member.databinding.ActivityRegisterBinding
import com.sanctum.member.models.RegisterRequest
...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun setupListeners() {
        ...
        binding.tvSearchChurch.setOnClickListener {
            val intent = Intent(this, com.sanctum.member.ui.church.ChurchSearchActivity::class.java)
