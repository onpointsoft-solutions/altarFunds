...
import com.altarfunds.member.databinding.ItemCommentBinding
import com.altarfunds.member.models.Comment
        ...
        fun bind(comment: Comment) {
            ...
            if (!comment.userAvatar.isNullOrEmpty()) {
                Glide.with(binding.root.context)
                    ...
                    .circleCrop()
                    .placeholder(com.altarfunds.member.R.drawable.ic_user_placeholder)
                    .into(binding.ivUserAvatar)
            } else {
                binding.ivUserAvatar.setImageResource(com.altarfunds.member.R.drawable.ic_user_placeholder)
            }
            
            // Like button state
            binding.btnLike.isSelected = comment.isLiked
            val likeIcon = if (comment.isLiked) {
                com.altarfunds.member.R.drawable.ic_heart_filled
            } else {
                com.altarfunds.member.R.drawable.ic_heart_outline
            }
