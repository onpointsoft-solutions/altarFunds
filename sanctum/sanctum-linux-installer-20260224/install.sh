...
# Sanctum Church Management System - Linux Installer
echo "🏛️ Sanctum Church Management System - Linux Installer"
echo "===================================================="
echo
...
cp "$(dirname "$0")/SanctumChurchManagement.jar" "$INSTALL_DIR/"
if [ $? -eq 0 ]; then
