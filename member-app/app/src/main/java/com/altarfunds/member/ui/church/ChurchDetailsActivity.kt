...
class ChurchDetailsActivity : AppCompatActivity() {
    ...
    private fun displayChurchDetails(church: com.altarfunds.member.models.Church) {
        ...
        binding.tvDenomination.text = church.denomination?.name ?: "No denomination"
        binding.tvLocation.text = church.location ?: "No location"
        binding.tvEmail.text = church.email ?: "No email"
        binding.tvPhone.text = church.phone ?: "No phone"
